...
class FooterWidget(QFrame):
    def __init__(self, parent=None):
        ...
        feature_request_label = QLabel('<a href="https://github.com/RysanekDavid/The-Tarnished-Chronicle/issues/new?assignees=&labels=enhancement&projects=&template=&title=Feature%20Request%3A%20" style="color: #81A1C1;">💡 Request Feature</a>')
